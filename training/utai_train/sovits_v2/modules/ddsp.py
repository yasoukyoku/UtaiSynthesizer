# Vendored verbatim from so-vits-svc 4.0-v2 (modules/ddsp.py @ cf5a8fb).
# Changes vs upstream: this header only. Live functions for training/infer are
# upsample / scale_function / remove_above_nyquist; the rest (extract_pitch
# references an undefined `crepe`, extract_loudness uses librosa 0.8 positional
# args) are dead code kept verbatim and never called.
import torch
