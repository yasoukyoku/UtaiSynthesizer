# vendored: openvpi/SingingVocoders @ 4d0889c (2026-03-08) -- process.py
...
import librosa
from utai_train.vocoder.utils.config_utils import read_full_config
from utai_train.vocoder.utils.wav2F0 import PITCH_EXTRACTORS_NAME_TO_ID, get_pitch
