# Vendored verbatim from so-vits-svc 4.1-Stable (models.py @ 730930d).
# Changes vs upstream: package-relative imports; the nsf-snake-hifigan vocoder
# branch raises (vdecoder/hifiganwithsnake is not vendored — our config template
# pins vocoder_name to nsf-hifigan and the converter rejects snake models too).
import torch
