# Vendored VERBATIM from so-vits-svc 4.1-Stable diffusion/dpm_solver_pytorch.py
# (@ 730930d). Zero changes — only reached by solver test() when infer.method is
# dpm-solver/dpm-solver++ (our template default dpm-solver++).
import torch
