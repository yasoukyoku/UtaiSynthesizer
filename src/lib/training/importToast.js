 ...
 */
export function collectWarningCodes(outcome, frontendWarn) {
 ...
 */
export function importToast(base, warnLines) {
 ...
 */
export function batchImportToast(a) {
 ...
 */
export function attachToasts(base, warnLines) {
    return [
        { text: base, level: "success" },
        ...warnLines.map((w) => ({ text: w, level: "info" })),
    ];
}
