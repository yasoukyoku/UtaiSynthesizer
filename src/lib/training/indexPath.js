...
function candidates(backend, workspace) {
    if (backend === "rvc")
        return [`${workspace}\\total_fea.npy`];
    return [`${workspace}\\cluster\\kmeans_10000.pt`, `${workspace}\\cluster\\0.index_vectors.npy`];
}
export async function resolveArchiveIndex(input) {
