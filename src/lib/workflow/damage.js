 ...
 */
const L0 = { level: 0, snrDb: Infinity };
const L1 = { level: 1, snrDb: 60 };
const L2 = { level: 2, snrDb: 35 };
const L3 = { level: 3, snrDb: 25 };
const L4 = { level: 4, snrDb: 15 };
export const NODE_DAMAGE = {
    // I/O 与零处理：原样透传
    input: L0,
    output: L0,
    split: L0,
 ...
 */
export function cumulativeSnrDb(snrDbs) {
    let sum = 0;
