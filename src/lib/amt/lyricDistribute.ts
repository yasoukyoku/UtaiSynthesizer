...
function joinToken(a: string, b: string): string {
  const cjk = /[\u4e00-\u9fff\u3040-\u30ff\u3000-\u303f\uff00-\uffef]/;
 ...
 */
export function mergeLyricLines(lines: TimedLyric[], gapSec = 0.5): TimedLyric[] {
  const sorted = [...lines]
