...
export function autoUpdateCheckEnabled() {
    return loadSetting(AUTO_CHECK_KEY, true);
}
export function setAutoUpdateCheckEnabled(v) {
...
export async function checkForUpdate() {
    ...
    return await invoke("update_check", { ghRoutes: ghRouteOrder(ghMirror, ghPresets) });
}
