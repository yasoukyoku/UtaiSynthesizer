...
export function TransposeNode(props) {
    ...
    const formantOffset = params.formantOffset ?? 0;
    return (_jsx(NodeShell, { nodeId: props.id, label: "Signalsmith", icon: "[S]", color: "#fbbf24", inputs: 1, outputs: 1, children: _jsx("div", { className: "sep-node-body", children: _jsxs("div", { className: "sep-params", children: [_jsx(ParamSliderWithUnit, { label: t18({ zh: "半音", en: "Semitones", ja: "半音" }, lang), unitType: "semitones", title: t18({
                        ...
                        }, lang), min: -24, max: 24, step: 1, value: semitones, onChange: (v) => updateParams({ semitones: v }) }), _jsx(ParamSlider, { label: t18({ zh: "共振峰跟随", en: "Formant follow", ja: "フォルマント追従" }, lang), title: t18({
                        ...
                        }, lang), min: 0, max: 1, step: 0.01, value: formantFollow, format: (v) => v.toFixed(2), onChange: (v) => updateParams({ formantFollow: v }) }), _jsx(ParamSliderWithUnit, { label: t18({ zh: "共振峰偏移", en: "Formant shift", ja: "フォルマントシフト" }, lang), unitType: "semitones", title: t18({
                        ...
                        }, lang), min: -24, max: 24, step: 1, value: formantOffset, onChange: (v) => updateParams({ formantOffset: v }) })] }) }) }));
}
