...
export function trackClassLabel(cls) {
...
export function TrackClassChips({ value, onChange, multi }) {
    ...
    return (_jsx("div", { className: "sep-params", style: { gap: 2 }, children: ACE_TRACK_CLASSES.map((cls) => (_jsxs("label", { className: "sep-param-row", style: { cursor: "pointer" }, children: [_jsx("span", { children: trackClassLabel(cls) }), _jsx("input", { type: multi ? "checkbox" : "radio", name: multi ? undefined : "song-lego-track", checked: value.includes(cls), onChange: () => toggle(cls), className: "nodrag" })] }, cls))) }));
}
/** 源文本节点正文 textarea 的统一样式（对齐 ChordBlockInNode 的内联样式）。 */
export const songTextAreaStyle = {
    width: "100%",
    fontSize: 12,
    padding: 6,
    borderRadius: 6,
